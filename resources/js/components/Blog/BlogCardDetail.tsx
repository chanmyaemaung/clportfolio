...
import { ScrollRevealSection } from '../UI';

export const BlogCardDetail = ({ blog }: BlogDetailProps) => {
    return (
            ...
            <div className="mx-auto max-w-4xl">
                <ScrollRevealSection>
                    ...
                    <div className="rich-text-content">
                        ...
                        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                            Pellentesque luctus lacus at velit sagittis fringilla. Cras non augue nec dolor mollis eleifend. Donec lobortis malesuada
                            arcu. Sed vel sapien non odio placerat venenatis. Duis et ligula eu eros dictum convallis ac vitae urna. Suspendisse
                            potenti. Cras sit amet massa eu eros eleifend vulputate. Nulla facilisi.
                        </p>

                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Blog Subheading</h2>

                        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Curabitur feugiat ante est, eget
                            placerat arcu volutpat et. Morbi sodales tellus non auctor pharetra. Nulla facilisi. Donec at fermentum nulla, quis
                            tincidunt erat. Nulla facilis urna non aliquam convallis. Etiam non blandit eros.
                        </p>

                        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                            Curabitur varius sapien eu dui vulputate, vel finibus metus fringilla. Donec libero ex, vulputate vel aliquet at,
                            convallis a lorem. Ut venenatis enim at nulla dictum, sed fringilla mauris elementum. Suspendisse potenti. Nulla facilisi.
                        </p>
                    </div>
                </ScrollRevealSection>
            </div>
